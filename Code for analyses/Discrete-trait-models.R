...
#Code modified from Julien Clavel - please reference him accordingly (mvMORPH)
#mvMORPH 
...
#Making another simmap - can use whichever sta you are interested in 
